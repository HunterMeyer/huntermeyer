...
$(function() {
  ...
  $("form#get-zip").submit(function() {
    ...
    $.get("https://congress.api.sunlightfoundation.com/legislators/locate?apikey=5b596ceec88a42d98151d7b383431dc9&zip=" + zip, function(responseBody) {
      responseBody.results.forEach(function(legislator) {
        $("div#card-container").append("<div class='leftHeader' id='cards" + i + "'></div>");
        var img_src = 'https://theunitedstates.io/images/congress/225x275/'
        ...
        $("li#bills").click(function() {
          $.get("https://congress.api.sunlightfoundation.com/bills?apikey=5b596ceec88a42d98151d7b383431dc9&sponsor_id__in=" + legislator.bioguide_id, function(resultBody) {
        ...
        if (legislator.twitter_id != null) {
          $("ul#person" + i).append("<a target='_blank' href='https://www.twitter.com/" + legislator.twitter_id + "'><img class='icons' src='https://googledrive.com/host/0BzGPB-VGfaP5LTBjZ0VPSEo4azA/twitter.png'>").hide().fadeIn();
        }
        if (legislator.youtube_id != null) {
          $("ul#person" + i).append("<a target='_blank' href='https://www.youtube.com/user/" + legislator.youtube_id + "'><img class='icons' src='https://googledrive.com/host/0BzGPB-VGfaP5LTBjZ0VPSEo4azA/youtube.png'>").hide().fadeIn();
        }
        if (legislator.facebook_id != null) {
          $("ul#person" + i).append("<a target='_blank' href='https://www.facebook.com/" + legislator.facebook_id + "'><img class='icons' src='https://googledrive.com/host/0BzGPB-VGfaP5LTBjZ0VPSEo4azA/facebook.png'>").hide().fadeIn();
        }
        i++;
      });
    });
